...
<div class="oneTwo">
	<div class="widget">
		<div class="title">
			<img src="{!! url('public/admin/images/icons/dark/money.png') !!}" class="titleIcon" />
			<h6>Doanh số</h6>
		</div>
...
<div class="oneTwo">
	<div class="widget">
		<div class="title">
			<img src="{!! url('public/admin/images/icons/dark/users.png') !!}" class="titleIcon" />
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable myTable">
			<tbody>
				...
				<tr>
					<td>
						<div class="left">Tổng số sản phẩm nhập vào</div>
				...
				<tr>
					<td>
						<div class="left">Tổng số sản phẩm bán ra</div>
...
<div class="clear"></div>	
	...
	<div class="widget">
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<thead>
				<tr>
					<td style="width:10px;"><img src="{!! url('public/admin/images/icons/tableArrows.png') !!}" /></td>
