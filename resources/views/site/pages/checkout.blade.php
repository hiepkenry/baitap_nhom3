          ...
          <div class="checkoutstep">
            <div class="cart-info">
              <table class="table table-striped table-bordered">
                ...
                <tr>
                  <td class="image"><a href="#"><img title="product" alt="product" src="{!! url('public/site/img/product/khoahoc5.jpg') !!}" height="50" width="50"></a></td>
                  ...
                  <td class="quantity"><input type="text" size="1" value="1" name="quantity[40]" class="span1">
                    ...
                    <a href="#"><img class="tooltip-test" data-original-title="Remove"  src="{!! url('public/site/img/remove.png') !!}" alt=""></a></td>
                ...
                <tr>
                  ...
                  <td class="quantity"><input type="text" size="1" value="1" name="quantity[40]" class="span1">
                    &nbsp;
                    <a href="#"><img class="tooltip-test" data-original-title="Update" src="{!! url('public/site/img/update.png') !!}" alt=""></a>
                    <a href="#"><img class="tooltip-test" data-original-title="Remove" src="{!! url('public/site/img/remove.png') !!}" alt=""></a></td>
                  <td class="price">$120.68</td>
                  <td class="total">$120.68</td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="quantity"><input type="text" size="1" value="1" name="quantity[40]" class="span1">
                    ...
                    <a href="#"><img class="tooltip-test" data-original-title="Update" src="{!! url('public/site/img/update.png') !!}" alt=""></a>
                    <a href="#">
                      <img class="tooltip-test" data-original-title="Remove" src="{!! url('public/site/img/remove.png') !!}" alt=""></a></td>
